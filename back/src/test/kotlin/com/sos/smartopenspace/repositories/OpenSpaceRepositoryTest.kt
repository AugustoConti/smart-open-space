...
import com.sos.smartopenspace.TestingObjectFactory
...
class OpenSpaceRepositoryTest {
    ...
    val objectFactory = TestingObjectFactory()
    ...
    fun `a track cannot be saved with description over 500 characters`() {
        ...
        val openSpace = objectFactory.anOpenSpace(tracks = setOf(invalidTrack))
